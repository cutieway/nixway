...
Home Manager hides these bind mounts from Thunar's **Devices** section and adds
their home paths to **Places** instead. This only changes their presentation;
their contents still live on `/dev/sda5`.
