...
in
{
  ...
  programs.bash = {
    ...
    initExtra = ''
      ...
      update_ai() ( _nixway_update llm-agents && ccr-models )
      readonly -f update_ai

      update_system() ( _nixway_update nixpkgs nixpkgs-unstable home-manager nix-cachyos-kernel llm-agents && ccr-models )
